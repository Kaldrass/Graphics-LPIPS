...
@REM **TMQ_NR_1VP_yf03_kfolds**
python config.py -m TMQ_NR_1VP_yf03_kfolds -use_folds True -v 1 -vm Original -rm Old_Render -db "TMQ" -mos "D:\These\BDD\TexturedMeshes\TMQ\Collected_Data\MOS+CI_3000stimuli.csv" -testlist "D:\These\Graphics-LPIPS\dataset\TexturedDB_20%%_TestList_withnbPatchesPerVP_threth0.6.csv"
python config.py -m TMQ_NR_1VP_yf03_kfolds -use_folds True -v 1 -vm Original -rm New_Render -db "TMQ" -mos "D:\These\BDD\TexturedMeshes\TMQ\Collected_Data\MOS+CI_3000stimuli.csv" -testlist "D:\These\Graphics-LPIPS\dataset\TexturedDB_20%%_TestList_withnbPatchesPerVP_threth0.6.csv"
python config.py -m TMQ_NR_1VP_yf03_kfolds -use_folds True -v 1 -vm Y_fixed_0.3 -rm New_Render -db "TMQ" -mos "D:\These\BDD\TexturedMeshes\TMQ\Collected_Data\MOS+CI_3000stimuli.csv" -testlist "D:\These\Graphics-LPIPS\dataset\TexturedDB_20%%_TestList_withnbPatchesPerVP_threth0.6.csv"
python config.py -m TMQ_NR_1VP_yf03_kfolds -use_folds True -v 1 -vm Fibonacci -rm New_Render -db "TMQ" -mos "D:\These\BDD\TexturedMeshes\TMQ\Collected_Data\MOS+CI_3000stimuli.csv" -testlist "D:\These\Graphics-LPIPS\dataset\TexturedDB_20%%_TestList_withnbPatchesPerVP_threth0.6.csv"
python config.py -m TMQ_NR_1VP_yf03_kfolds -use_folds True -v 1 -vm Y_fixed_0.3 -rm New_Render -db "TSMD" -mos "D:\These\BDD\TexturedMeshes\TSMD\MOS\TSMD_MOS.csv" -testlist "D:\These\Graphics-LPIPS\dataset\TSMD\_TSMD_fulldataset.csv"
python config.py -m TMQ_NR_1VP_yf03_kfolds -use_folds True -v 1 -vm Fibonacci -rm New_Render -db "TSMD" -mos "D:\These\BDD\TexturedMeshes\TSMD\MOS\TSMD_MOS.csv" -testlist "D:\These\Graphics-LPIPS\dataset\TSMD\_TSMD_fulldataset.csv"

@REM **TMQ_NR_4VP_yf03_kfolds**
python config.py -m TMQ_NR_4VP_yf03_kfolds -use_folds True -v 1 -vm Original -rm Old_Render -db "TMQ" -mos "D:\These\BDD\TexturedMeshes\TMQ\Collected_Data\MOS+CI_3000stimuli.csv" -testlist "D:\These\Graphics-LPIPS\dataset\TexturedDB_20%%_TestList_withnbPatchesPerVP_threth0.6.csv"
python config.py -m TMQ_NR_4VP_yf03_kfolds -use_folds True -v 4 -vm Original -rm Old_Render -db "TMQ" -mos "D:\These\BDD\TexturedMeshes\TMQ\Collected_Data\MOS+CI_3000stimuli.csv" -testlist "D:\These\Graphics-LPIPS\dataset\TexturedDB_20%%_TestList_withnbPatchesPerVP_threth0.6.csv"
python config.py -m TMQ_NR_4VP_yf03_kfolds -use_folds True -v 4 -vm Original -rm New_Render -db "TMQ" -mos "D:\These\BDD\TexturedMeshes\TMQ\Collected_Data\MOS+CI_3000stimuli.csv" -testlist "D:\These\Graphics-LPIPS\dataset\TexturedDB_20%%_TestList_withnbPatchesPerVP_threth0.6.csv"
python config.py -m TMQ_NR_4VP_yf03_kfolds -use_folds True -v 4 -vm Y_fixed_0.3 -rm New_Render -db "TMQ" -mos "D:\These\BDD\TexturedMeshes\TMQ\Collected_Data\MOS+CI_3000stimuli.csv" -testlist "D:\These\Graphics-LPIPS\dataset\TexturedDB_20%%_TestList_withnbPatchesPerVP_threth0.6.csv"
python config.py -m TMQ_NR_4VP_yf03_kfolds -use_folds True -v 4 -vm Fibonacci -rm New_Render -db "TMQ" -mos "D:\These\BDD\TexturedMeshes\TMQ\Collected_Data\MOS+CI_3000stimuli.csv" -testlist "D:\These\Graphics-LPIPS\dataset\TexturedDB_20%%_TestList_withnbPatchesPerVP_threth0.6.csv"
python config.py -m TMQ_NR_4VP_yf03_kfolds -use_folds True -v 4 -vm Y_fixed_0.3 -rm New_Render -db "TSMD" -mos "D:\These\BDD\TexturedMeshes\TSMD\MOS\TSMD_MOS.csv" -testlist "D:\These\Graphics-LPIPS\dataset\TSMD\_TSMD_fulldataset.csv"
python config.py -m TMQ_NR_4VP_yf03_kfolds -use_folds True -v 4 -vm Fibonacci -rm New_Render -db "TSMD" -mos "D:\These\BDD\TexturedMeshes\TSMD\MOS\TSMD_MOS.csv" -testlist "D:\These\Graphics-LPIPS\dataset\TSMD\_TSMD_fulldataset.csv"
