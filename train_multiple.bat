...
@REM echo Testing...
@REM @REM **SJTU-TMQA**
@REM python config.py -m TMQ_NR_1VP_yf03_kfolds -v 4 -vm Y_fixed_0 -rm New_Render -db "SJTU-TMQA" -mos ".\dataset\SJTU-TMQA\SJTU-TMQA_MOS_1-5.csv" -testlist ".\dataset\SJTU-TMQA\SJTU-TMQA_MOS_normalized.csv"  --use_folds
...
python config.py -m BASICS_SP_1VP_yf00_kfolds -v 1 -vm Y_fixed_0 -rm SP -db "BASICS(PC)_DB" -mos "D:\These\Graphics-LPIPS\dataset\BASICS(PC)_DB\MOS_CI.csv" -testlist "D:\These\Graphics-LPIPS\dataset\BASICS(PC)_DB\folds\MOS_CI_test20.csv" --use_folds
python config.py -m BASICS_SP_1VP_yf00_kfolds -v 4 -vm Y_fixed_0 -rm SP -db "BASICS(PC)_DB" -mos "D:\These\Graphics-LPIPS\dataset\BASICS(PC)_DB\MOS_CI.csv" -testlist "D:\These\Graphics-LPIPS\dataset\BASICS(PC)_DB\folds\MOS_CI_test20.csv" --use_folds
python config.py -m BASICS_SP_4VP_yf00_kfolds -v 1 -vm Y_fixed_0 -rm SP -db "BASICS(PC)_DB" -mos "D:\These\Graphics-LPIPS\dataset\BASICS(PC)_DB\MOS_CI.csv" -testlist "D:\These\Graphics-LPIPS\dataset\BASICS(PC)_DB\folds\MOS_CI_test20.csv" --use_folds
python config.py -m BASICS_SP_4VP_yf00_kfolds -v 4 -vm Y_fixed_0 -rm SP -db "BASICS(PC)_DB" -mos "D:\These\Graphics-LPIPS\dataset\BASICS(PC)_DB\MOS_CI.csv" -testlist "D:\These\Graphics-LPIPS\dataset\BASICS(PC)_DB\folds\MOS_CI_test20.csv" --use_folds

python config.py -m TMQ_NR_1VP_yf03_kfolds --use_folds -v 1 -vm Y_fixed_0 -rm SP -db "BASICS(PC)_DB" -mos "D:\These\Graphics-LPIPS\dataset\BASICS(PC)_DB\MOS_CI.csv" -testlist "D:\These\Graphics-LPIPS\dataset\BASICS(PC)_DB\MOS_CI_01.csv"
python config.py -m TMQ_NR_1VP_yf03_kfolds --use_folds -v 4 -vm Y_fixed_0 -rm SP -db "BASICS(PC)_DB" -mos "D:\These\Graphics-LPIPS\dataset\BASICS(PC)_DB\MOS_CI.csv" -testlist "D:\These\Graphics-LPIPS\dataset\BASICS(PC)_DB\MOS_CI_01.csv"
python config.py -m TMQ_NR_4VP_yf03_kfolds --use_folds -v 1 -vm Y_fixed_0 -rm SP -db "BASICS(PC)_DB" -mos "D:\These\Graphics-LPIPS\dataset\BASICS(PC)_DB\MOS_CI.csv" -testlist "D:\These\Graphics-LPIPS\dataset\BASICS(PC)_DB\MOS_CI_01.csv"
python config.py -m TMQ_NR_4VP_yf03_kfolds --use_folds -v 4 -vm Y_fixed_0 -rm SP -db "BASICS(PC)_DB" -mos "D:\These\Graphics-LPIPS\dataset\BASICS(PC)_DB\MOS_CI.csv" -testlist "D:\These\Graphics-LPIPS\dataset\BASICS(PC)_DB\MOS_CI_01.csv"
