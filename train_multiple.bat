...
python config.py -m SJTU-TMQA_NR_4VP_yf0_kfolds -v 4 -vm Y_fixed_0.3 -rm New_Render -db "TMQ" -mos "D:\These\BDD\TexturedMeshes\TMQ\Collected_Data\MOS+CI_3000stimuli.csv" -testlist "./dataset/TMQ/folds/TexturedDB_100%%_TrainList_withnbPatchesPerVP_threth0.6.csv" --use_folds
python config.py -m SJTU-TMQA_NR_4VP_fib_kfolds -v 4 -vm Fibonacci -rm New_Render -db "TMQ" -mos "D:\These\BDD\TexturedMeshes\TMQ\Collected_Data\MOS+CI_3000stimuli.csv" -testlist "./dataset/TMQ/folds/TexturedDB_100%%_TrainList_withnbPatchesPerVP_threth0.6.csv" --use_folds
python config.py -m SJTU-TMQA_NR_8VP_yf03_kfolds -v 8 -vm Y_fixed_0.3 -rm New_Render -db "TMQ" -mos "D:\These\BDD\TexturedMeshes\TMQ\Collected_Data\MOS+CI_3000stimuli.csv" -testlist "./dataset/TMQ/folds/TexturedDB_100%%_TrainList_withnbPatchesPerVP_threth0.6.csv" --use_folds
python config.py -m SJTU-TMQA_NR_8VP_fib_kfolds -v 8 -vm Fibonacci -rm New_Render -db "TMQ" -mos "D:\These\BDD\TexturedMeshes\TMQ\Collected_Data\MOS+CI_3000stimuli.csv" -testlist "./dataset/TMQ/folds/TexturedDB_100%%_TrainList_withnbPatchesPerVP_threth0.6.csv" --use_folds
