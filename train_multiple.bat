...
python train.py --name TMQ_NR_1VP_fib_kfolds --src_root "D:\These\Projets\CompareMetrics\out\TMQ\New_Render\Fibonacci" --root_refPatches "\Source\1VP" --root_distPatches "\Distorted\1VP" --target "judges"
echo training TMQ_NR_1VP_fib_kfolds done.
python train.py --name TMQ_NR_4VP_fib_kfolds --src_root "D:\These\Projets\CompareMetrics\out\TMQ\New_Render\Fibonacci" --root_refPatches "\Source\4VP" --root_distPatches "\Distorted\4VP" --target "judges"
echo training TMQ_NR_4VP_fib_kfolds done.
python train.py --name TMQ_NR_8VP_fib_kfolds --src_root "D:\These\Projets\CompareMetrics\out\TMQ\New_Render\Fibonacci" --root_refPatches "\Source\8VP" --root_distPatches "\Distorted\8VP" --target "judges"
echo training TMQ_NR_8VP_fib_kfolds done.
